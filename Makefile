...
$(IMAGE): glass
	...
	@ wget https://github.com/limine-bootloader/limine/blob/latest-binary/BOOTX64.EFI
	@ mv BOOTX64.EFI image/EFI/BOOT/BOOTX64.EFI
	@ cp $(GLASS) image/sys/start/glass.knl
...
run:
	@ qemu-system-x86_64 -bios /usr/share/ovmf/OVMF.fd -hda $(IMAGE) -net none