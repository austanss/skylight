...
// Tracks and accounts for capslock, numlock, and shift by itself
char kbd_char_decode(uint8_t keycode);

enum KERNEL_KEYBOARD_CODES {
...
#define KBD_KEYCODE_CHAR_MAX 0x42
extern uint8_t kbd_key_ascii_default[];
extern uint8_t kbd_key_ascii_numlock[];
extern uint8_t kbd_key_ascii_capslock[];
extern uint8_t kbd_key_ascii_numlock_capslock[];
extern uint8_t kbd_key_ascii_shift[];
extern uint8_t kbd_key_ascii_shift_numlock[];
extern uint8_t kbd_key_ascii_shift_capslock[];
extern uint8_t kbd_key_ascii_shift_numlock_capslock[];
